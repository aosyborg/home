...
syntax keyword javaScriptType           const this self undefined var void yield window document
...
if exists("b:javascript_fold")
    ...
    syntax region  javaScriptFuncBlock      contained matchgroup=javaScriptFuncBlock start="{" end="}" contains=@javaScriptAll,javaScriptParensErrA,javaScriptParensErrB,javaScriptParen,javaScriptBracket,javaScriptBlock
